...
export default function EditExamination({ examination, classes, subjects }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        classes: examination.classes,
        subjects: examination.subjects,
    });

    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/academic/examinations/${examination.id}`);
    };
    ...
    return (
        <AppLayout>
            <Head title={`Edit ${examination.name}`} />
            ...
            <div className="flex h-full flex-1 flex-col gap-6 overflow-x-auto rounded-xl p-6">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold tracking-tight">Edit Examination</h1>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex items-center justify-end space-x-4 pt-6">
                                <Button variant="outline" asChild>
                                    <Link href={`/academic/examinations/${examination.id}`}>Cancel</Link>
                                </Button>
                                <Button type="submit" disabled={processing}>
                                    {processing ? 'Updating...' : 'Update Examination'}
                                </Button>
                            </div>
                        </form>
                    </CardContent>
